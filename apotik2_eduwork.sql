...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jun 20, 2024 at 07:34 AM
...
ALTER TABLE `tb_detail_pasien`
  ...
  ADD KEY `fk_detailpasien` (`id_pasien`);
...
--
ALTER TABLE `tb_detail_pasien`
  ADD CONSTRAINT `fk_detailpasien` FOREIGN KEY (`id_pasien`) REFERENCES `tb_pasien` (`id_pasien`);
